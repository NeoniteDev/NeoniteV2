...
app.post("/party/api/v1/*/parties/:PartyId/members/*/join", (req, res) => {
    res.json({ "status": "JOINED", "party_id": req.params.PartyId });
});

app.post("/party/api/v1/*/parties/LobbyBotPartyLMFAO/members/:displayName/disconnect", (req, res) => {
    res.status(204).end();
});

app.post("/party/api/v1/*/parties/:partyId/members/*/confirm", (req, res) => {
    res.status(403).end();
});

app.patch("/party/api/v1/*/parties/:partyId", (req, res) => {
    res.status(204).send();
});

app.delete("/party/api/v1/*/parties/:partyId", (req, res) => {
    res.status(204).send();
});
...
app.post("/party/api/v1/*/parties/:PartyId/members/:accountId/promote", (req, res) => {
    res.status(204).end();
});
