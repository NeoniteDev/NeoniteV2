...
module.exports = (app, port) => {
    ...
    app.get(
        ["/content/api/pages/fortnite-game", "/content/api/pages/"],
        async (req, res) => {
            var season = "9";
            try {
            ...
            res.json({
                ...
                "jcr:baseVersion":
                    "a7ca237317f1e7b00bc82e-d9a2-4f0d-b951-704d295cd1aa",
                ...
                shopCarousel: {
                    ...
                    _noIndex: false,
                    "jcr:baseVersion":
                        "a7ca237317f1e765be23f9-d0fd-4067-ae00-ef29af2376cc",
                ...
                dynamicbackgrounds: content.dynamicbackgrounds || {
                    ...
                    _noIndex: false,
                    "jcr:baseVersion":
                        "a7ca237317f1e70712af90-59fe-4576-8f32-f80bf513c946",
                ...
                shopSections: {
                    ...
                    _noIndex: false,
                    "jcr:baseVersion":
                        "a7ca237317f1e77453e266-613d-435e-9dd1-f549c0255030",
    ...
    // Not sure about POST Method up there ^^ but for GET this is how I would carry the request out
    app.get("/api/v1/fortnite-br/surfaces/motd/target", (req, res) => {
        // Useful for offline use but commented out since we are going to use Nitestats for this
        // Nitestats implementation

        let motd = await axios
            .get("https://api.nitestats.com/v1/epic/prm/motd")
            .then((response) => {
 ...
 res.json({
  ...
  "tcId": "f8ba54e8-7627-4f78-b354-9970c95e6efa",
  "contentItems": [
    {
      "contentType": "content-item",
      "contentId": "f8a3b42c-c6ef-4afb-9fa9-b3e5ca04eac9",
      "tcId": "8201d436-288e-4061-81aa-2e7ea33c96e7",
      "contentFields": {
        "body": "Move quiet as a whisper and silence the opposition with razor sharp precision.",
        "buttonTextOverride": "Grab It",
        "entryType": "Item",
        "image": [
          {
            "width": 1920,
            "height": 1080,
            "url": "https://cdn-live.prm.ol.epicgames.com/prod/45edab6814e12edbf11812da17afa98beba0e64c8671d73869e9ced7b6ad70a523469a7e13923fc5bff68a7836c61116-e4a87ee6-3fe3-4b77-8329-28c715b6243e.jpeg?width=1920"
          },
          {
            "width": 960,
            "height": 540,
            "url": "https://cdn-live.prm.ol.epicgames.com/prod/45edab6814e12edbf11812da17afa98beba0e64c8671d73869e9ced7b6ad70a523469a7e13923fc5bff68a7836c61116-e4a87ee6-3fe3-4b77-8329-28c715b6243e.jpeg?width=960"
          }
        ],
        "offerAction": "ShowOfferDetails",
        "offerId": "v2:/164f7c5b389d07c47082c6b0ef70a47287d0ccb5911143d5d92f20037d19ace2",
        "tabTitleOverride": "New Style",
        "tileImage": [
          {
            "width": 1024,
            "height": 512,
            "url": "https://cdn-live.prm.ol.epicgames.com/prod/45edab6814e12edbf11812da17afa98beba0e64c8671d73869e9ced7b6ad70a59ddb53927ef233c163d0102d3c3db11b-01bc33b0-a09c-420e-810e-cfa809a3dc8c.jpeg?width=1024"
          }
        ],
        "title": "Hush"
      },
      "contentSchemaName": "MotdItem",
